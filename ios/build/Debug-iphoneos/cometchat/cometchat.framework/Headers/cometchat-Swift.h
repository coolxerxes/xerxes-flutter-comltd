...
#ifndef COMETCHAT_SWIFT_H
#define COMETCHAT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="cometchat",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9cometchat20SwiftCometchatPlugin")
@interface SwiftCometchatPlugin : NSObject <FlutterPlugin>
...
@interface SwiftCometchatPlugin (SWIFT_EXTENSION(cometchat)) <CometChatUserDelegate>
- (void)onUserOnlineWithUser:(User * _Nonnull)user;
- (void)onUserOfflineWithUser:(User * _Nonnull)user;
@end


@interface SwiftCometchatPlugin (SWIFT_EXTENSION(cometchat)) <CometChatConnectionDelegate>
- (void)connecting;
- (void)connected;
- (void)disconnected;
@end
...
@interface SwiftCometchatPlugin (SWIFT_EXTENSION(cometchat)) <FlutterStreamHandler>
...
@interface SwiftCometchatPlugin (SWIFT_EXTENSION(cometchat)) <CometChatLoginDelegate>
...
@interface SwiftCometchatPlugin (SWIFT_EXTENSION(cometchat)) <CometChatGroupDelegate>
...
@interface SwiftCometchatPlugin (SWIFT_EXTENSION(cometchat)) <CometChatMessageDelegate>
