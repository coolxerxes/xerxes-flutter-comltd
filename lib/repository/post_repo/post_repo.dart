...
import '../../models/posts_model/TSuggestedPeople.dart';
import '../../models/posts_model/post_and_activity_model.dart';

abstract class PostRepo {
  Future<AttachmentResponseModel>? attachment(XFile? imgFile,{String? fileName, String? filePath});
  ...
  Future<TSuggestedPeople>? postSuggestedPeople(Map data);
