...
GetPostByUserResponseModel getPostByUserResponseModelFromJson(String str) => GetPostByUserResponseModel.fromJson(json.decode(str));

String getPostByUserResponseModelToJson(GetPostByUserResponseModel data) => json.encode(data.toJson());
...
class GetPostByUserResponseModel {
    ...
    factory GetPostByUserResponseModel.fromJson(Map<String, dynamic> json) => GetPostByUserResponseModel(
        status: json["status"],
...
class Datum {
    ...
    factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        attachment: (json["attachment"] == null || json["attachment"] == "null" ) ? [] : List<Attachment>.from((jsonDecode(json["attachment"] )as List) .map((x) => Attachment.fromJson(x))),
        document: (json["documents"] == null || json["documents"] == "null")
            ? []
            : List<Document>.from(jsonDecode(json["documents"])
        ...
        tagUserInfo: json["tagUserInfo"] == null ? null : TagUserInfo.fromJson(json["tagUserInfo"]),
        jioMeUserInfo: json["jioMeUserInfo"] == null ? [] : json["jioMeUserInfo"] is List ?  List<JioMeUserInfo>.from(json["jioMeUserInfo"]!.map((x) => JioMeUserInfo.fromJson(x))):[],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "jioMeUserInfo": jioMeUserInfo == null ? [] : List<dynamic>.from(jioMeUserInfo!.map((x) => x.toJson())),
        "isLiked": isLiked,
        "isJioMe": isJioMe,
    };
}
